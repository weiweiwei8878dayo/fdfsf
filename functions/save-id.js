...
exports.handler = async (event) => {
    ...
    try {
        ...
        const { userId, userName, status, lastUpdate, item, amount, banOption, ssUrl, orderId, chatMsg } = data;
        ...
        if (index !== -1) json[index] = { ...json[index], ...newEntry };
        else json.push(newEntry);
